...
#[divan::bench(max_time = 1)]
fn day21() {
    let _ = aoc::day21::part2::process(divan::black_box(include_str!("../src/day21/input.txt")));
}
...
#[divan::bench(max_time = 1)]
fn day24() {
    let _ = aoc::day24::part2::process(divan::black_box(include_str!("../src/day24/input.txt")));
}